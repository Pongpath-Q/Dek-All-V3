  ...
  const NAV = [
    ...
    `;
      ...
      <div class="grid grid-3 anim-slide-up" style="animation-delay:0.1s;">
        ...
        <div class="card" style="padding:var(--space-5);">
          <div style="font-size:32px;margin-bottom:var(--space-3);">🔢</div>
          <div style="font-weight:700;color:var(--navy-900);">โจทย์ความเข้าใจเรื่องจำนวน</div>
          <div style="font-size:var(--text-xs);color:var(--slate-500);margin-top:2px;">แบบฝึกคณิตศาสตร์พร้อมระบบรางวัลแบบเกม</div>
          <button class="btn btn-primary btn-sm btn-full lib-preview-btn" style="margin-top:var(--space-4);" data-name="โจทย์ความเข้าใจเรื่องจำนวน">ดูตัวอย่างโจทย์</button>
        </div>
        <div class="card" style="padding:var(--space-5);">
          <div style="font-size:32px;margin-bottom:var(--space-3);">🧠</div>
          <div style="font-weight:700;color:var(--navy-900);">คู่มือฝึกสมาธิ</div>
          <div style="font-size:var(--text-xs);color:var(--slate-500);margin-top:2px;">กิจกรรมฝึกการจดจ่อและการรับรู้ทางประสาทสัมผัส</div>
          <button class="btn btn-primary btn-sm btn-full lib-preview-btn" style="margin-top:var(--space-4);" data-name="คู่มือฝึกสมาธิ">ดูตัวอย่างกิจกรรม</button>
        </div>
      </div>
    `;
    }
