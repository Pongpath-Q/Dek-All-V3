...
export function renderParentDashboard(container, activeTab = 'parent') {
    ...
    // ──────────────────────────────────────────
      ...
      <div class="grid grid-3 anim-slide-up" style="animation-delay:0.2s;">
        ...
        <div class="stat-card">
          ...
          <div class="stat-label">คะแนนคณิตศาสตร์</div>
          <div class="stat-trend trend-up">↑ อยู่ในระดับดี</div>
        </div>
      </div>
    `;
    ...
    // ──────────────────────────────────────────
      ...
      <div class="card anim-slide-up" style="margin-bottom:var(--space-6);">
        ...
        <div style="padding:var(--space-5);display:flex;flex-direction:column;gap:var(--space-4);">
          ${[
            { from: 'คุณครูซาราห์ เฉิน', emoji: '👩‍🏫', date: '2026-06-18', note: `${child.name} มีพัฒนาการด้านการใช้เหตุผลทางคณิตศาสตร์ดีขึ้น โปรดส่งเสริมให้ฝึกฝนทุกวันต่อไป`, type: 'badge-success', label: 'พัฒนาการดี' },
