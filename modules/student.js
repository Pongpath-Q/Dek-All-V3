    ...
    // ──────────────────────────────────────────
        ...
        const badges = [
            ...
            },
            {
                ...
                desc: 'ทำงานฝึกทักษะให้สำเร็จ',
                unlocked: myTasks.some(t => t.type.includes('การฝึกทักษะ') && t.status[profile.id] === 'completed'),
                badge: 'badge-info',
            },
            {
                emoji: '📖',
                ...
                unlocked: myTasks.some(t => t.type.includes('การอ่าน') && t.status[profile.id] === 'completed'),
                badge: 'badge-warning',
            },
        ];
